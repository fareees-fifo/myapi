...
API_ID = 1710051635
API_HASH = "939745cea0d5ef543278c0d96231dd00"
BOT_TOKEN = "6899797841:AAHsicM8rF-kIiGfKP87xKC6k6TswwlGzH0"
...
def format_scr_response(results: Dict, user_info: Dict) -> str:
    ...
    status_part = f"""<pre><a href='https://t.me/farxxes'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝑪𝒐𝒎𝒑𝒍𝒆𝒕𝒆𝒅</b> ✅</pre>"""
    
    source_part = f"""<a href='https://t.me/farxxes'>⌬</a> <b>𝑺𝒐𝒖𝒓𝒄𝒆</b> ↬ <code>{source}</code>"""
    
    # Use bullet points for cards found and duplicates removed
    cards_part = f"""<a href='https://t.me/farxxes'>⊀</a> <b>𝑪𝒂𝒓𝒅𝒔 𝑭𝒐𝒖𝒏𝒅</b> ↬ <code>{cards_found}</code>
<a href='https://t.me/farxxes'>⊀</a> <b>𝑫𝒖𝒑𝒍𝒊𝒄𝒂𝒕𝒆𝒔 𝑹𝒆𝒎𝒐𝒗𝒆𝒅</b> ↬ <code>{duplicates_removed}</code>"""
    
    filter_part = ""
    if bin_filter:
        filter_part += f"<a href='https://t.me/farxxes'>⊀</a> <b>𝑩𝑰𝑵 𝑭𝒊𝒍𝒕𝒆𝒓</b> ↬ <code>{bin_filter}</code>"
    if bank_filter:
        filter_part += f"<a href='https://t.me/farxxes'>⊀</a> <b>𝑩𝒂𝒏𝒌 𝑭𝒊𝒍𝒕𝒆𝒓</b> ↬ <code>{bank_filter}</code>"
...
<a href='https://t.me/farxxes'>⊀</a> <b>𝑺𝒐𝒖𝒓𝒄𝒆</b> ↬ <code>{channel_name}</code>
<a href='https://t.me/farxxes'>⊀</a> <b>𝑳𝒊𝒎𝒊𝒕</b> ↬ <code>{limit}</code>
<a href='https://t.me/farxxes'>⊀</a> <b>𝑭𝒊𝒍𝒕𝒆𝒓</b> ↬ <code>{bin_filter or bank_filter or 'None'}</code>"""
